...
# Auto-emission feedback loop removed from JS payload
_HTML_PAYLOAD = """
<!DOCTYPE html>
<html>
<head>
...
if active_data is not None:
    ...
    # --- System State Synchronization Resolver ---
    ...
    if not render_nodes:
        ...
        if per_page == "All":
            ...
            <script>
                (function() {
                    const hooks = document.querySelectorAll('.pagination-container-hook');
                    hooks.forEach(hook => {
                        ...
                        if (elContainer && elContainer.nextElementSibling) {
                            ...
                            if (cols.length >= 3) {
                                ...
                                cols[1].style.cssText = 'flex: 1 1 auto !important; min-width: 0 !important; padding: 0 !important; margin: 0 !important;';
                                cols[2].style.cssText = 'flex: 0 0 45px !important; min-width: 0 !important; width: 45px !important; padding: 0 !important; margin: 0 !important;';
                            }
                            let btns = hBlock.querySelectorAll('button');
                            btns.forEach(btn => {
                                btn.style.cssText = 'height: 42px !important; padding: 0 !important; line-height: 1 !important;';
                            });
                        }
                    });
                })();
            ...
            with page_ui_col2:
                ...
                raw_page_sel = native_selectbox(
                    ...
                    key=f"native_page_{current_filter_hash}_{chunks}_{st.session_state.pagination_index}"
                )
